...
out.write("<h2><div style=\"border :1px solid white; float: left; width: 33%; text-align:center;\">"+year+"년</div></h2>");
out.write("<h2><div style=\"border :1px solid white; float: left; width: 33%;text-align:center;\">"+month+"월</div></h2>");
